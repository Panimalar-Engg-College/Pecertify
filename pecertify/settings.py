"""
Django settings for pecertify project.
...
SECRET_KEY = 'django-insecure-&_+x)m6pw&7j3jtn307nb&ebijwek65^=7w5mg__-ycr)eoe#2'
...
WSGI_APPLICATION = 'pecertify.wsgi.application'
